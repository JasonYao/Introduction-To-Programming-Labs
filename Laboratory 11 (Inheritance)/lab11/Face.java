...
// A head portion typically is typically shaped as an oval, with the
...
public class Face {
    ...
    //   'helpDrawOn' mmethod, which is the method that actually does the
    ...
    protected void drawHair(Graphics g) {
		// Use the approiate color.  The draw an oval-shaped splotch of
        // hair so that it extends 10% of the way above the head, and goes
        // most of the way across.
        g.setColor(this.hairColor());
        g.fillOval(pixelX(10), pixelY(-10), distX(80), distY(25));
    }
